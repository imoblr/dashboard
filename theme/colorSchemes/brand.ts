...
import { gray, brand as brandColor } from "../colors";
...
export const brand = {
  'light': vars({
    ...
    '--color-background-darker-a1': Color(gray['50']).alpha(0.9),
    '--color-background-darker-a2': Color(gray['50']).alpha(0.75),
    '--color-background-darker-a3': Color(gray['50']).alpha(0.6),
    '--color-background-darkest': gray['500'],
    '--color-background-darkest-a1': Color(gray['500']).alpha(0.9),
    '--color-background-darkest-a2': Color(gray['500']).alpha(0.75),
    '--color-background-darkest-a3': Color(gray['500']).alpha(0.6),
