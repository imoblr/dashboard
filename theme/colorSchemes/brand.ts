...
export const brand = {
  'light': vars({
    ...
    '--color-background-darker': gray['25'],
    ...
    '--color-background-darkest': gray['50'],
    '--color-background-darkest-a1': Color(gray['100']).alpha(0.9),
    '--color-background-darkest-a2': Color(gray['100']).alpha(0.75),
