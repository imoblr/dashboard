...
export const brand = {
  'light': vars({
    ...
    '--color-background-darker': brandColor['25'],
    '--color-background-darker-a1': Color(brandColor['50']).alpha(0.9),
    '--color-background-darker-a2': Color(brandColor['50']).alpha(0.75),
    '--color-background-darker-a3': Color(brandColor['50']).alpha(0.6),
    '--color-background-darkest': gray['200'],
    '--color-background-darkest-a1': Color(gray['200']).alpha(0.9),
    '--color-background-darkest-a2': Color(gray['200']).alpha(0.75),
    '--color-background-darkest-a3': Color(gray['200']).alpha(0.6),
