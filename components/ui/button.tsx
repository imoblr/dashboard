	...
	"group flex flex-row items-center justify-center web:ring-offset-background web:transition-colors web:focus-visible:outline-none web:focus-visible:ring-2 web:focus-visible:ring-ring web:focus-visible:ring-offset-2",
	{
		variants: {
			variant: {
				...
				outline:
					"border border-border bg-background native:shadow-[0_1px_3px_0_var(--color-shadow-dark)] web:shadow-[inset_0_-1px_1px_0_var(--color-shadow-dark),0_1px_3px_0_var(--color-shadow)] web:hover:bg-gray-50 web:hover:text-accent-foreground active:bg-accent",
			...
			size: {
				default:
					"h-10 px-4 py-2 rounded-xl native:h-12 native:px-5 native:py-3",
				sm: "h-9 rounded-lg px-3",
				lg: "h-12 rounded-2xl px-6 native:h-14",
				icon: "h-10 w-10",
			},
		},
		defaultVariants: {
