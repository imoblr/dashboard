	...
	return (
		<Box className="w-[64px] h-full overflow-visible z-50">
			<Box className="h-full w-[240px] bg-background border-r-[1px] border-border-lighter p-2 pt-4">
				<Center className="h-[32px] w-[32px] absolute top-10 right-[-16px] z-50 bg-background rounded-full border border-border-lighter shadow-xs">
					<Icon
						as={CollapseLeftIcon}
						className="text-text-quaternary w-[18px] h-[18px]"
					/>
				</Center>
				<Box className="pl-2">
